...
public class Sprites {
	 ...
	 * @param nom        nom de reference de l'image chargee
	 * @param nomFichier nom du fichier à charger
	 * @param dx         pos de départ
	 * @param dy         pos de départ
	 * @param tx         taille X
	 * @param ty         taille Y
	 *
	 */
	...
	/**
	 * permet de charger une feuille de sprite réguliere à partir de la feuille et
	 * du nombre de ligne et de colonnes.
	 * 
	 * <pre>
	 ...
	 * @param nx         nombre de sprites par ligne
	 * @param ny         nombre de sprites par colonne
	 */
